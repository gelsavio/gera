# Formato GERA — Gerador de Acompanhamentos Song — versão 3

Arquivo-modelo: `modelo-tempo-perdio-format-v3.json`

## Identificação

- `app`: deve ser `GERA — Gerador de Acompanhamentos`.
- `format`: deve ser `gera-song`.
- `formatVersion`: `3`.
...
Objeto calculado pelo GERA — Gerador de Acompanhamentos. Cada valor é a soma de `fraction` de todos os acordes e pausas daquela seção.
