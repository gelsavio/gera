...
test('HTML, manifesto e SERVICE WORKER carregam uma vez o módulo da 8H',function(){
 ...
 assert.ok(sw.includes("const CACHE_NAME = CACHE_PREFIX + 'v3.15.54';"));assert.equal(JSON.parse(fs.readFileSync(path.join(root,'manifest.json'),'utf8')).version,'3.15.54');
